PGM
     ...
     CRTCMOD MODULE(QNTCSDK/MKTABLE) +
          SRCSTMF('/QNTCSDK/SAMPLES/RICHTEXT/MKTABLE/MKTABLE.C') +
          SYSIFCOPT(*IFSIO) +
          DBGVIEW(*ALL) +
          DEFINE(OS400 UNIX) +
          TGTCCSID(37) +
     ...
     CRTCMOD MODULE(QNTCSDK/CDRECORD) +
          SRCSTMF('/QNTCSDK/SAMPLES/RICHTEXT/MKTABLE/CDRECORD.C') +
          SYSIFCOPT(*IFSIO) +
          DBGVIEW(*ALL) +
     ...
     CRTCMOD MODULE(QNTCSDK/CDTABLE) +
          SRCSTMF('/QNTCSDK/SAMPLES/RICHTEXT/MKTABLE/CDTABLE.C') +
          SYSIFCOPT(*IFSIO) +
          DBGVIEW(*ALL) +
          DEFINE(OS400 UNIX) +
          TGTCCSID(37) +
