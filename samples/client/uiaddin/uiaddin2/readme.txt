...
PROGRAM
-------
uiaddin2  -  Sample Notes Client Menu Add-in Program
...
with the HCL C API for Domino and Notes toolkit.  Make sure this database
...
Start the Notes client and pull down the Actions menu.  The menu items
