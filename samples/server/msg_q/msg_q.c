/****************************************************************************
    ...
    PURPOSE:    HCL Domino Server message queue sample

    SYNTAX:     (at the HCL Domino Server console) > load msg_q
    ...
    DESCRIPTION:
        ...
        message to the HCL Domino Server log file.
...
/************************************************************************
    ...
    ALGORITHM:
         ...
         Enters a loop until the HCL Domino Server terminates or 
         an error occurs.
         Within this loop:
