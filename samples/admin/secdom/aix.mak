...
LINKOPTS = -o $(TARGET) -bE:exports.aix -bM:SRE -bnoentry -bD:0x20000000

# Notes API header files require UNIX to be defined.
DEFINES =  -qcpluscmt -DUNIX -DAIX -D_REENTRANT -DUSE_THREADSAFE_INTERFACES
...
LIBS = -lnotes_r -lm -lc_r -lpthreads
